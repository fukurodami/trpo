...
class Reader(models.Model):
    ...
    city = models.CharField("Город", max_length=40)
    index = models.CharField("Почтовый индекс отделения", max_length=40)
    book = models.ForeignKey(Book, verbose_name="Книга", on_delete=models.SET_NULL, null=True, blank=True)
    check_post = models.BooleanField("Обработан", default=False)
